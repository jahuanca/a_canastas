...
const routes: Routes = [
  ...
  { path: 'select-app', loadChildren: () => import('./modules/select-app/select-app.module').then(m => m.SelectAppModule), canActivate: [UnAuthGuard]},
  { path: 'bloqueados', loadChildren: () => import('./modules/bloqueados/bloqueados.module').then(m => m.BloqueadosModule) },
  { path: 'SelectApp', loadChildren: () => import('./modules/select-app/select-app.module').then(m => m.SelectAppModule) },
